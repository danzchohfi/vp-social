...
// Mobile: hamburger abre overlay fullscreen via React Portal no <body>
// — sair do stacking context do <header> (e de qualquer relative/z-index
// ancestral) é o que garante que o overlay sobrepõe tudo, incluindo
// elementos com z-index alto da própria página.
...
export function PublicHeader() {
  ...
  // Mount flag pra createPortal — document.body só existe no client.
  ...
  return (
    <header className="relative border-b border-border/70 backdrop-blur-sm">
      ...
      {/* Renderiza overlay em portal no <body> pra escapar do stacking
          context do header (e de qualquer ancestral com z-index ou
          position: relative na página). Renderiza só após mount client. */}
